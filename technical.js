...
const array = [
    ...
    '<a href="Blogs/2020/06/23/IBM-abandon-facial-recognition-technology.html"> IBM Abandon Facial Recognition Technology</a> <br> <p class = "preview"> CEO Arvind Krishna said, in a letter to members of congress, that there is a potential for police to use facial recognition to violate “basic human rights and freedoms” at that they have come to the decision to end all research and development of such technologies... </p>',
    '<a href="Blogs/2020/06/24/Tracking-location-data-to-curb-covid19.html"> Tracking Location Data to Curb Covid-19 </a> <br> <p class="preview"> The government can now track the spread of covid by monitoring which people an infected individual interacted with by analysing location data... </p>',
];
